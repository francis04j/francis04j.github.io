...
function shiftUpDownHorizontalLayersOnResize() {
    ...
    pageVerticalPosition <= sea1Div.offsetLeft + sea1Div.offsetWidth - robbyRightEdge && 
    (clearInterval(shiftUpLayerHorizontalTimer), 
    clearInterval(shiftDownLayerHorizontalTimer), isRobbySwimming = !0, 
    ...
    (pageVerticalPosition < sea1Div.offsetLeft - robbyLeftEdge ||
         ...
         isRobbySwimming = !1,
        "horizontal" == layersMovement ? (positionLayerHorizontalToBottom(), positionVerticalLayersBottomToHorizontalLayersBottom()) : 
        (positionHorizontalLayersAtBottomMost(), positionHorizontalLayersToHaveSameRightPosition()), clearInterval(bubbleTimer), clearInterval(blinkSeaAnimalsTimer))
}
...
function positionLayerHorizontalToBottom() {
    if (0 == isRobbySwimming) {
        for (var e = 0; e < layerHorizontalArray.length; e++) layerHorizontalArray[e].style.top = "20px";
...
function turnOnAndOffScrollOrSwipeTextContainer() {
    "computer" == deviceName ? ($(scrollOrSwipeTextContainer1Div).fadeTo(0, 1), $(scrollOrSwipeTextContainer1Div).stop().delay(3000).animate({
        opacity: 0
    }, 0, function () { })) : ($(scrollOrSwipeTextContainer2Div).fadeTo(0, 1), $(scrollOrSwipeTextContainer2Div).stop().delay(3000).animate({
        opacity: 0
    }, 0, function () { }))
}
...
numberOfFishInEachRowArray.push(3, 3, 2, 3);
...
numberOfCrabInEachRowArray.push(3, 2, 3, 2);
...
numberOfTurtleInEachRowArray.push(3, 3, 3, 3);
